...
//             await axios.post('http://localhost:4000/ad/', registration)   /// After Hosting change to hosted backend name
//               .then(res => {
//                 if (!res.data.message) {
//                   console.log("ok");
//                 } else {
...
//             await axios.post('http://localhost:4000/as/', registration)   /// After Hosting change to hosted backend name
//               .then(res => {
//                 if (!res.data.message) {
//                   console.log("ok")
//                 } else {
